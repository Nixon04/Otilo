...
import { computed as computed2, defineComponent as defineComponent2, onMounted, onUnmounted, ref as ref3 } from "vue";
var deferred_default = defineComponent2({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      return propsAreDefined && !hasRescuedProps ? slots.default?.({ reloading: reloading.value }) : hasRescuedProps && slots.rescue ? slots.rescue({ reloading: reloading.value }) : slots.fallback({});
    };
  }
});
...
import { computed as computed4, defineComponent as defineComponent5, Fragment, h as h4, onMounted as onMounted3, onUnmounted as onUnmounted2, ref as ref5, watch as watch3 } from "vue";
...
import { computed as computed5, defineComponent as defineComponent6, h as h5, onMounted as onMounted4, onUnmounted as onUnmounted3, ref as ref6 } from "vue";
var noop2 = () => {
};
...
import { computed as computed6, defineComponent as defineComponent7, h as h6, nextTick, onUnmounted as onUnmounted6, ref as ref9, watch as watch5 } from "vue";
